...
class HRX
  ...
  # given node object will only ever have one position in the list. This
  # invariant is maintained by all methods of LinkedList::List other than
  ...
  class OrderedNode < LinkedList::Node
    def initialize(data)
      super
      @order = nil
    end
    ...
    #
    # This is guaranteed to be greater than the order of all nodes before this
    # in the list, and less than the order of all nodes after it. Otherwise it
